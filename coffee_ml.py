...
df = pd.read_csv('COFFEE.CMDUSX_Candlestick_5_M_ASK_04.12.2017-03.05.2019-exact.csv', sep=',')
df2 = pd.read_csv('COCOA.CMDUSD_Candlestick_5_M_ASK_04.12.2017-03.05.2019-exact.csv', sep=',')
