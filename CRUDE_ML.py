...
df = pd.read_csv('LIGHT.CMDUSD_Candlestick_5_M_ASK_04.05.2016-04.05.2019.csv', sep=',')
df2 = pd.read_csv('BRENT.CMDUSD_Candlestick_5_M_ASK_04.05.2016-04.05.2019.csv', sep=',')
...
df.loc[df['Close'].shift(-1) > df['Close'] + 0.03, 'Predicted' ] = 1
df.loc[df['Close'].shift(-1) < df['Close'] - 0.03, 'Predicted' ] = -1
